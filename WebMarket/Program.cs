...
var stringConnectdb = builder.Configuration.GetConnectionString("dbWebMarket");
...
builder.Services.AddDbContext<MarketContext>(options => options.UseSqlServer(stringConnectdb));
